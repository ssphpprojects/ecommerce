							...
							<div class="module-body">
									...
									<form action="" method="post" enctype="multipart/form-data" class="form-horizontal row-fluid">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" name="title" placeholder="Add Title" class="span8 title">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Slug</label>
											<div class="controls">
												<input type="text" id="basicinput" name="slug" placeholder="Add Slug" class="span8 slug">
											</div>
										</div>
										<div class="control-group">
