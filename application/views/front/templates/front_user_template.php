			...
			<div class="row">
				<div class="col-md-3">
					<div class="list-group">
						<a href="<?php echo site_url('user/profile'); ?>" class="list-group-item">Profile</a>
						<a href="<?php echo site_url('user/favorites'); ?>" class="list-group-item">Favorite</a>
						<a href="<?php echo site_url('user/downloads'); ?>" class="list-group-item">Downloads</a>
					</div>
				</div>
				<div class="col-md-9">
